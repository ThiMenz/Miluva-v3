...
namespace ChessBot
{
    public static class LegacyEngineManager
    {
        ...
        {
            string[] strs = File.ReadAllLines(PathManager.GetTXTPath("ENGINE/SnapshotResults"));
        ...
        public static void SaveGlickoEntities()
        {
            ...
            File.WriteAllLines(PathManager.GetTXTPath("ENGINE/SnapshotResults"), gEntries);
        }
        ...
        public static void PlayBetweenTwoSnapshots(IBoardManager[] pBM1, IBoardManager[] pBM2, long pTime, int pFENCount)
        {
            ...
            File.AppendAllLines(PathManager.GetTXTPath("ENGINE/Clashes"), new string[5] 
            {   
                "[" + DateTime.Now.ToShortDateString() + "] " + ge1.NAME + " vs " + ge2.NAME + " (" + (pFENCount * 2) + " Games): " + curClashResultTuple.Item1 + "\\" + curClashResultTuple.Item2 + "\\" + curClashResultTuple.Item3,
